...
export default function DashboardPage() {
  ...
  const stats = useMemo(
    () => [
      ...
      { label: 'Ready products', value: products.filter((product) => product.isEnabled !== false).length, detail: 'Products with a workspace or setup path.', icon: CheckCircle2, tone: 'teal' },
  ...
  const suiteProducts = [
    ...
    },
    {
      ...
      summary: 'Classroom worksheet and practice document workflow runs through the shared DOCX workspace.',
    ...
    },
    {
      ...
      summary: 'Question paper, question sheet, and practice set workflow runs through the shared DOCX workspace.',
    ...
    },
    {
      ...
      summary: 'Student report and progress document workflow runs through the shared DOCX workspace.',
    ...
    },
    {
      ...
      summary: 'Fee receipt document workflow runs through the shared DOCX workspace.',
      suiteLabel: 'Education / Fee Receipts',
      status: 'Product workspace',
      badge: 'Product workspace',
      active: true,
    ...
    },
    {
      ...
      summary: 'Structured marksheet document workflow runs through the shared DOCX workspace.',
    ...
    },
    {
      ...
      summary: 'Professional invoice document workflow runs through the shared DOCX workspace.',
    ...
    },
    {
      ...
      summary: 'Receipt generation for fee records and client acknowledgements.',
      suiteLabel: 'Office / Business Suite',
      status: 'Request setup',
      badge: 'Request setup',
      active: false,
    },
    {
      ...
      summary: 'Prepare personalized mail batches from Excel data and templates with dry-run validation. No real sending is enabled in Project Atlas.',
  ...
  const suiteSections = [
    ...
    },
    {
      ...
      description: 'Offer letters, employee IDs, admin documents, and safe mail preparation.',
      tone: 'hr',
      products: suiteProducts.filter((card) => card.suiteLabel === 'HR / Admin Suite' || card.suiteLabel.startsWith('HR / Admin /')),
    },
    {
          ...
          <div className="grid gap-6 lg:grid-cols-[1.2fr_auto] lg:items-center">
            <div>
              ...
              <p className="mt-3 max-w-3xl leading-7 text-slate-600">
                This dashboard keeps your product workflow clean and ready to use. Continue AR-CERT-PRO, start a new generation, or review History from one place.
              </p>
            </div>
            <div className="rounded-lg border border-slate-200 bg-slate-50 p-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-primary">v2.64 product readiness</p>
                </div>
              </div>
            </div>
          </div>
