...
export default function DashboardPage() {
  ...
  const suiteProducts = [
    ...
    },
    {
      ...
      summary: 'Fee receipt document workspace can be scoped and set up for client operations.',
    ...
    },
    {
      ...
      summary: 'Structured marksheet document workflow is ready for product workspace setup.',
    ...
    },
    {
      ...
      summary: 'Professional invoice document workflow is ready for product workspace setup.',
