...
const sharedFields = {
  ...
  offerLetter: [
    { id: 'candidatename', label: 'CandidateName', placeholder: '{{CandidateName}}', required: true, type: 'text', sample: 'Priya Sharma' },
    { id: 'jobtitle', label: 'JobTitle', placeholder: '{{JobTitle}}', required: true, type: 'text', sample: 'Junior Administrator' },
    { id: 'department', label: 'Department', placeholder: '{{Department}}', required: true, type: 'text', sample: 'Administration' },
    { id: 'joiningdate', label: 'JoiningDate', placeholder: '{{JoiningDate}}', required: true, type: 'date', sample: 'July 15, 2026' },
    { id: 'salary', label: 'Salary', placeholder: '{{Salary}}', required: true, type: 'text', sample: '₹25,000 per month' },
    { id: 'companyname', label: 'CompanyName', placeholder: '{{CompanyName}}', required: true, type: 'text', sample: 'AaryaRushi Automation Labs' },
    { id: 'hrname', label: 'HRName', placeholder: '{{HRName}}', required: false, type: 'text', sample: 'Rushi Cherukuri' },
  ],
}
...
export const sharedDocumentWorkspaceConfigs = {
  ...
  'ar-offer-letter-pro': createSharedDocumentWorkspaceConfig({
    id: 'offer-letter',
    productSlug: 'ar-offer-letter-pro',
    productName: 'AR-OFFER-LETTER-PRO',
    suite: 'HR / Admin Suite',
    templateLabel: 'Offer letter template',
    excelLabel: 'Candidate details Excel',
    outputLabel: 'Offer letters',
    placeholderExamples: ['{{CandidateName}}', '{{JobTitle}}', '{{Department}}', '{{JoiningDate}}', '{{Salary}}', '{{CompanyName}}', '{{HRName}}'],
    shortName: 'Offer letter',
    primaryFieldId: 'candidatename',
    idFieldId: 'jobtitle',
    workspacePattern: 'data-template',
    eyebrow: 'AR-OFFER-LETTER-PRO Workspace',
    title: 'Offer Letter DOCX Workspace',
    description: 'Prepare offer letters from Excel data and Word templates.',
    placeholderHelp: 'Example: {{CandidateName}} matches CandidateName, {{JobTitle}} matches JobTitle, and {{JoiningDate}} matches JoiningDate in the Candidate details Excel.',
    templateFields: sharedFields.offerLetter,
    copy: {
      templateTitle: 'Upload offer letter template',
      templateDescription: 'Choose a DOCX offer letter template using engine placeholders such as {{CandidateName}}, {{JobTitle}}, {{Department}}, {{JoiningDate}}, {{Salary}}, {{CompanyName}}, and {{HRName}}.',
      templateEmptyText: 'No offer letter DOCX template uploaded yet.',
      excelEmptyText: 'No candidate details Excel uploaded yet.',
      excelTitle: 'Upload candidate details Excel',
      excelDescription: 'Choose the spreadsheet with one candidate per row. Column headers are detected in the browser.',
      previewTitle: 'Preview one offer letter row',
      previewDescription: 'Review one candidate row before generating DOCX offer letters.',
      previewCardEyebrow: 'Offer letter preview',
      previewDocumentTitle: 'Offer Letter',
      previewSentence: (values) => `Role: ${values.jobtitle || 'JobTitle'} / Joining: ${values.joiningdate || 'JoiningDate'}`,
      previewNameField: 'candidatename',
      previewIdField: 'jobtitle',
      previewIdFallback: 'JOB-TITLE',
      optionalField: 'hrname',
      optionalFieldLabel: 'HR name',
    },
  }),
}
