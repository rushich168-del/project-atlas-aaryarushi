...
export const sharedDocumentWorkspaceConfigs = {
  ...
  'ar-worksheet-pro': createSharedDocumentWorkspaceConfig({
    ...
    copy: {
      ...
      generateDescription: 'Generate one worksheet DOCX from the preview, or generate a batch from every valid content row.',
  ...
  'ar-question-pro': createSharedDocumentWorkspaceConfig({
    ...
    copy: {
      ...
      generateDescription: 'Generate one question paper DOCX from the preview, or generate a batch from every valid question-bank row.',
